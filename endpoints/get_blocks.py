...
@app.get("/blocks/{blockId}", response_model=BlockModel, tags=["Stokes blocks"])
async def get_block(
    response: Response,
...
@app.get("/blocks", response_model=BlockResponse, tags=["Stokes blocks"])
...
@app.get("/blocks-from-bluescore", response_model=List[BlockModel], tags=["Stokes blocks"])
